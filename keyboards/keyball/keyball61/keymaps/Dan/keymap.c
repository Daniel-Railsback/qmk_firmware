...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    QK_GESC   , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     ,                                  KC_MINUS     , KC_6     , KC_7     , KC_8     , KC_9     , KC_0  ,
    KC_BSLS   , KC_Q     , KC_W     , KC_E     , KC_R     , KC_T     ,                                  KC_UP     , KC_Y     , KC_U     , KC_I     , KC_O     , KC_P  ,
    KC_TAB   , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                  KC_DOWN     , KC_H     , KC_J     , KC_K     , KC_L  , KC_SCLN  ,
    KC_RSFT    , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_LBRC  ,              KC_LEFT, KC_RGHT     , KC_N     , KC_M  , KC_COMM   , KC_DOT  , KC_QUOTE  ,
    KC_LCTL  , KC_LALT  , KC_LWIN  , KC_LGUI,LT(1,KC_SPC),LT(2,QK_MOUSE_CURSOR_LEFT),LT(3,QK_MOUSE_CURSOR_RIGHT),    KC_BSPC,LT(2,KC_ENT),LT(1,KC_LNG2),KC_RGUI, _______ , KC_EQL  , KC_PSCR
  ),
